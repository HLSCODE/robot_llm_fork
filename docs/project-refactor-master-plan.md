...
> 最近更新：2026-08-04
>
> 当前里程碑：M5 — 应用级 LLM 生命周期已收敛，继续治理表现层边界
> 计划进度：114/123（112 DONE + 2 DROPPED，92.7%）
...
1. **G-016**：整理 GUI/WebSocket 表现层目录，并移除其对 DeviceRuntime 的直接读取。
2. **G-018/G-019**：分批拆解 core、删除兼容/未引用路径，并扩展依赖边界和类型门禁。
