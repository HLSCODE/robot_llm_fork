...
TARGET_POSE = [0.277553,-0.002143,-0.436172,2.441000,1.486000,-0.628000]

def main():
    print("=" * 50)
    print("Robot1 movej 移动测试")
    print("=" * 50)

    print("\n正在连接机械臂...")
    robot = RoboticArm(rm_thread_mode_e.RM_TRIPLE_MODE_E)
    robot_handle = robot.rm_create_robot_arm(ROBOT1_CONFIG["ip"], ROBOT1_CONFIG["port"])
    ...
    print(f"机械臂已连接: {ROBOT1_CONFIG['ip']}")
